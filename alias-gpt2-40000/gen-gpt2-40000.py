...
genTimes = 391
returnSeqNum = 256 
tokenizer = GPT2Tokenizer.from_pretrained("../../alias-gpt2-small-x21")
model = GPT2LMHeadModel.from_pretrained("../../alias-gpt2-small-x21",device_map="auto", load_in_8bit=True)
